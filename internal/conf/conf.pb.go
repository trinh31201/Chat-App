...
const file_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\x83\x04\n" +
	"\x04Data\x125\n" +
	...
	"\x11conn_max_lifetime\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x0fconnMaxLifetime\x1a\xc5\x01\n" +
	"\x05Redis\x12\x12\n" +
	...
	"\n" +
	"jwt_expire\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\tjwtExpire\"K\n" +
	"\x03Log\x12\x14\n" +
	"\x05level\x18\x01 \x01(\tR\x05level\x12\x16\n" +
	"\x06format\x18\x02 \x01(\tR\x06format\x12\x16\n" +
	"\x06output\x18\x03 \x01(\tR\x06outputB5Z3github.com/yourusername/chat-app/internal/conf;confb\x06proto3"
...
var file_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.Auth.jwt_expire:type_name -> google.protobuf.Duration
	...
	9,  // 11: kratos.api.Data.Database.conn_max_lifetime:type_name -> google.protobuf.Duration
